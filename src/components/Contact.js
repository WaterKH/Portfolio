        ...
        <section id="contact" className="relative">
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    ...
                    src="https://www.google.com/maps/embed/v1/place?q=Auckland+New+Zealand&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                    />
                    <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                        ...
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            ...
                            pjacobclark@outlook.com
                            </span>
                            <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                            PHONE
                            </h2>
                            <p className="leading-relaxed">021-024-22400</p>
                        </div>
                    </div>
                </div>
                <form 
                ...
                >
                    ...
                    <p className="leading-relaxed mb-5">
                        If you are interested in discussing opportunites, please leave your name and email along with your inquiry and I will respond to you as quickly as I can.
                    </p>
